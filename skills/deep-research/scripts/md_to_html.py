...
def main():
    """CLI for the converter"""
    import argparse
    import sys

    parser = argparse.ArgumentParser(
        description="Convert Markdown research report to HTML",
    ...
    parser.add_argument("--full", action="store_true", help="Wrap in full HTML document with basic styling")
...
h3 {{ color: #34495e; }}
.bib-entry {{ margin: 0.3em 0; font-size: 0.9em; }}
.bib-number {{ color: #e74c3c; font-weight: bold; }}
.executive-summary {{ background: #f8f9fa; padding: 1em; border-radius: 4px; }}
</style>
</head>
<body>
{content_html}
